...
export default function App(props: any) {
    ...
    async function triggerAuthAndSetCode() {
        window.location.replace('https://discord.com/api/oauth2/authorize?response_type=code&client_id=760234712446402560&scope=identify&audience=reppbuytool&state=gimble');
    }
